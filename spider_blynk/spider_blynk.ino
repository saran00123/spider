...
void setup(){
  ...
  joint2.attach(33, 1000, 2000);
  joint3.attach(32, 1000, 2000);
  joint4.attach(13, 1000, 2000);
  joint5.attach(12, 1000, 2000);
  joint6.attach(14, 1000, 2000);
  joint7.attach(27, 1000, 2000);
  joint8.attach(26, 1000, 2000);
  joint9.attach(25, 1000, 2000);
