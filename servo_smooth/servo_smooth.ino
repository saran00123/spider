...
//    Serial.println(F("Move to 135 degree with 40 degree per second blocking"));
    Servo1.easeTo(180, speed); // Blocking call, runs on all platforms
//    Servo2.easeTo(180, speed);
//    Serial.println(F("Move to 45 degree  with 40 degree per second blocking"));
    Servo1.easeTo(60, speed); // Blocking call, runs on all platforms
//    Servo2.easeTo(60, speed);
//    delay(1000);
}
